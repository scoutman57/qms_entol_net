...
<div class="container">
  ...
  <div class="login shadow" style="margin:15px auto; float:none; padding:0;">
    ...
    <div class="actions graybg"> <?php echo form_submit('submit', $this->lang->line("submit"), 'class="btn btn-primary" style="padding: 6px 15px;"');?> <a href="auth/login" style="margin-left:15px;"><?php echo $this->lang->line("back_to_login"); ?></a> </div>
